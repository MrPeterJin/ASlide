"""
Color Correction module for TMAP format.
...
class ColorCorrection:
    """Color correction processor for TMAP images using ICC profile."""

    # Default ICC directory (relative to this file)
    ICC_DIR = os.path.join(os.path.dirname(__file__), "icc")

    # Predefined ICC profiles (aligned with KFB/MDS/SDPC naming)
    PROFILES = {
        "Real": "real.icm",
    }
    ...
    def apply(self, image: Image.Image) -> Image.Image:
        ...
        try:
            ...
            # Apply ICC transform
            corrected = _ImageCms.applyTransform(rgb_image, self._transform)
