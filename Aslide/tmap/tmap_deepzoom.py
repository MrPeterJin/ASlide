#
# Deep Zoom support for TMAP format
#
# Based on openslide-python DeepZoom implementation
#

"""Support for Deep Zoom images from TMAP format slides.
...
class DeepZoomGenerator(object):
    """Generates Deep Zoom tiles and metadata for TMAP slides."""

    def __init__(self, osr, tile_size=254, overlap=1, limit_bounds=False):
        """Create a DeepZoomGenerator wrapping a TMAP slide object.

        osr:          a TmapSlide object (or Slide wrapper).
