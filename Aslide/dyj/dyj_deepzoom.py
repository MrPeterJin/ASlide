#
# Deep Zoom support for DYJ format
#
...
"""Support for Deep Zoom images from DYJ format slides.
...
class DeepZoomGenerator(object):
    """Generates Deep Zoom tiles and metadata for DYJ slides."""

    def __init__(self, osr, tile_size=254, overlap=1, limit_bounds=False):
        """Create a DeepZoomGenerator wrapping a DYJ slide object.

        osr:          a DyjSlide object (or Slide wrapper).
...
def main():
    ...
    dyj_file_path = "/path/to/your/slide.dyj"
    slide = DyjSlide(dyj_file_path)
    ...
    tile.save("dyj_deepzoom_tile.jpg")
    print("Tile saved to dyj_deepzoom_tile.jpg")
