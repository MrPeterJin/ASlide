#
# Deep Zoom support for ZYP format
#
...
"""Support for Deep Zoom images from ZYP format slides.
...
class DeepZoomGenerator(object):
    """Generates Deep Zoom tiles and metadata for ZYP slides."""

    def __init__(self, osr, tile_size=254, overlap=1, limit_bounds=False):
        """Create a DeepZoomGenerator wrapping a ZYP slide object.

        osr:          a ZypSlide object (or Slide wrapper).
