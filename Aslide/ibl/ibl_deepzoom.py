#
# Deep Zoom support for IBL format
#
...
"""Support for Deep Zoom images from IBL format slides.
...
class DeepZoomGenerator(object):
    """Generates Deep Zoom tiles and metadata for IBL slides."""

    def __init__(self, osr, tile_size=254, overlap=1, limit_bounds=False):
        """Create a DeepZoomGenerator wrapping an IBL slide object.

        osr:          an IblSlide object (or Slide wrapper).
